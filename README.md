...
[PyTorch](https://pytorch.org/) models (for more special purpose, it is recommend to use native library instead). It is made for easy and faster pipeline to train and evaluate several
